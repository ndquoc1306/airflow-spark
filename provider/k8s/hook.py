...
class CustomKubernetesHook(BaseHook):
    """
    ...
    def create_custom_object(
            self, additional_args: list, group: str, version: str, plural: str, body: str | dict,
            namespace: str | None = None
    ):
        """
        Creates custom resource definition object in Kubernetes
        :param additional_args: arguments
        ...
        if isinstance(body, str):
            ...
            body_dict = body
        body_dict['spec']['arguments'] = additional_args
